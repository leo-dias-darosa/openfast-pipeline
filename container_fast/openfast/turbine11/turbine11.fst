...
"../WP_Baseline_AeroDyn15_Dynin_turbine11.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
        300   SttsTime        - Amount of time between screen status messages (s)
