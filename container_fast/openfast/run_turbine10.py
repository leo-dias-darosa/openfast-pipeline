...
def main(simulation_timestamp):
    turbine10_input_file = "turbine10/turbine10.fst"
    turbsim_input_file = "turbine10/Wind/wind_model.inp"
    inflow_wind_file = "turbine10/WP_Baseline_InflowWind_12mps.dat"
    turbsim_wind_type = 4
    wind_speed_range = (5, 18)

    with OpenFastSimulation(simulation_timestamp,
                            turbine10_input_file,
                            turbsim_input_file,
                            inflow_wind_file,
                            turbsim_wind_type,
